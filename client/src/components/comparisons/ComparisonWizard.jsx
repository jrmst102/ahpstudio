...
const SLIDER_LABELS = [
  { val: 1 / 9, label: '1/9', desc: 'Extremely less important' },
  { val: 1 / 8, label: '1/8', desc: 'Very strongly to extremely less' },
  { val: 1 / 7, label: '1/7', desc: 'Very strongly less important' },
  { val: 1 / 6, label: '1/6', desc: 'Strongly to very strongly less' },
  { val: 1 / 5, label: '1/5', desc: 'Strongly less important' },
  { val: 1 / 4, label: '1/4', desc: 'Moderately to strongly less' },
  { val: 1 / 3, label: '1/3', desc: 'Moderately less important' },
  { val: 1 / 2, label: '1/2', desc: 'Equally to moderately less' },
  { val: 1, label: '1', desc: 'Equal importance' },
  { val: 2, label: '2', desc: 'Equally to moderately more' },
  { val: 3, label: '3', desc: 'Moderately more important' },
  { val: 4, label: '4', desc: 'Moderately to strongly more' },
  { val: 5, label: '5', desc: 'Strongly more important' },
  { val: 6, label: '6', desc: 'Strongly to very strongly more' },
  { val: 7, label: '7', desc: 'Very strongly more important' },
  { val: 8, label: '8', desc: 'Very strongly to extremely more' },
  { val: 9, label: '9', desc: 'Extremely more important' },
];
